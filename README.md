...
This repository is the working home for the SocioProphet Yang-Mills program artifacts: fixed-spacing strong-coupling SU(2) theorem work, obstruction-survey work, fiber-sensitive sharpening, and interface-specification planning.
...
- **Lane II - fiber-sensitive quantitative sharpening:** replace topology-blind polymer/rooted-animal entropy with boundary-fiber-sensitive surface, representation, and cancellation estimates.
